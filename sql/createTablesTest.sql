...
-- CREATE SCHEMA test; -- <<<<<< IF SCHEMA NEEDS TO BE CREATED WILL NEED TO UNCOMMENT THIS!!!!!!!!!


ALTER SCHEMA test OWNER TO karisch;
...
ALTER TABLE test.horses OWNER TO karisch;
...
ALTER TABLE test.races OWNER TO karisch;
...
ALTER TABLE ONLY test.horses
    ADD CONSTRAINT fk_horses_to_races FOREIGN KEY (track, date, race) REFERENCES test.races(track, date, race) NOT VALID;
